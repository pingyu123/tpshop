...
<div class="content">
    ...
    <a class="btn btn-primary" onclick="javascript:window.location.href='/index.php/Admin/Type/add'">新增</a>
        ...
        <table class="table table-bordered table-hover table-condensed">
            ...
            <tbody>
                <?php if(is_array($type)): $i = 0; $__LIST__ = $type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="success">
                    <td><?php echo ($v["type_id"]); ?></td>
                    <td><?php echo ($v["type_name"]); ?></td>
                    <td>
                        <a href="/index.php/Admin/Type/edit/type_id/<?php echo ($v["type_id"]); ?>"> 编辑 </a>
                        <a href="javascript:void(0);" onclick="if(confirm('确认删除？')) location.href='/index.php/Admin/Type/del/type_id/<?php echo ($v["type_id"]); ?>'"> 删除 </a>
                    </td>
