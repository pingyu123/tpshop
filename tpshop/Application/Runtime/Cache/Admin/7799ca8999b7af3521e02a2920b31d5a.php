...
<div class="content">
    ...
    <a class="btn btn-primary" onclick="javascript:window.location.href='/index.php/Admin/Attribute/add'">新增</a>
        ...
        <table class="table table-bordered table-hover table-condensed">
            ...
            <tbody>
                <?php if(is_array($attr)): $i = 0; $__LIST__ = $attr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="success">
                    <td><?php echo ($v["attr_id"]); ?></td>
                    <td><?php echo ($v["attr_name"]); ?></td>
                    <td><?php echo ($v["type_name"]); ?></td>
                    <td>
                        <?php if( $v["attr_type"] == 0 ): ?>唯一属性
                        <?php else: ?>
                        单选属性<?php endif; ?>
                    </td>
                    <td>
                        <?php if( $v["attr_input_type"] == 0 ): ?>input输入框
                    ...
                    <td>
                        <a href="/index.php/Admin/Attribute/edit/attr_id/<?php echo ($v["attr_id"]); ?>"> 编辑 </a>
                        <a href="javascript:void(0);" onclick="if(confirm('确认删除？')) location.href='/index.php/Admin/Attribute/del/attr_id/<?php echo ($v["attr_id"]); ?>'"> 删除 </a>
                    </td>
