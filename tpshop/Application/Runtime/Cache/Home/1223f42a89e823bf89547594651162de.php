				...
				<div class="clearfixLeft" id="clearcontent">
					...
					<div class="box">
						...
						<div class="tb-booth tb-pic tb-s310">
							<a href="/Public/Home/images/01.jpg"><img src="<?php echo ($goodspics[0]['pics_mid']); ?>" alt="细节展示放大镜特效" rel="<?php echo ($goodspics[0]['pics_big']); ?>" class="jqzoom" /></a>
						</div>
						<ul class="tb-thumb" id="thumblist">
							<?php if(is_array($goodspics)): $k = 0; $__LIST__ = $goodspics;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($k % 2 );++$k;?><li class="<?php if( $k == 1 ): ?>tb-selected<?php endif; ?>">
								<div class="tb-pic tb-s40">
									<a href="javascript:;"><img src="<?php echo ($vol["pics_sma"]); ?>" mid="<?php echo ($vol["pics_mid"]); ?>" big="<?php echo ($vol["pics_big"]); ?>"></a>
								</div>
									...
									<div class="theme-popbod dform">
										<form class="theme-signin" name="goodsform" action="/index.php/Home/Cart/addcart" method="post">
											<div class="theme-signin-left">
												<?php if(is_array($attr)): $i = 0; $__LIST__ = $attr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i; if( $vol["attr_type"] == 1 ): ?><div class="theme-options">
													<div class="cart-title attr"><?php echo ($vol["attr_name"]); ?></div>
													<ul>
														<?php if(is_array($goodsattr)): $k = 0; $__LIST__ = $goodsattr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k; if( $v["attr_id"] == $vol["attr_id"] ): ?><li goods_attr_id="<?php echo ($v["id"]); ?>" class="sku-line"><?php echo ($v["attr_value"]); ?><i></i></li><?php endif; endforeach; endif; else: echo "" ;endif; ?>
													</ul>
						...
						<div class="am-tabs-bd">
							...
							<div class="am-tab-panel am-fade am-in am-active">
								<div class="J_Brand">
									...
									<div class="clear"></div>
									<ul id="J_AttrUL">
										<?php if(is_array($attr)): $i = 0; $__LIST__ = $attr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i; if( $vol["attr_type"] == 0 ): ?><li title=""><?php echo ($vol["attr_name"]); ?>:&nbsp;
											<?php if(is_array($goodsattr)): $i = 0; $__LIST__ = $goodsattr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if( $v["attr_id"] == $vol["attr_id"] ): echo ($v["attr_value"]); endif; endforeach; endif; else: echo "" ;endif; ?>
...
<script type="text/javascript">
	$(function(){
		...
		$('#LikBasket').click(function(){
			...
			//获取所有的属性名称个数
			var attr = $('.attr');
			if(selected_li.length != attr.length){
				alert("必须选择规格");
				return;
			}
			var goods_attr_ids = '';
